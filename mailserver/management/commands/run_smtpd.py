...
Then check /mailserver/ in the Velour web UI — the message should
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        from mailserver.handler import VelourSMTPHandler
        from mailserver.models import SMTPServerConfig
