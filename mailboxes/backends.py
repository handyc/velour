...
Wiring this in via `EMAIL_BACKEND = 'mailboxes.backends.DynamicMailboxBackend'`
    ...
    def send_messages(self, email_messages):
        if self._account:
            ...
            for msg in email_messages:
                # Only overwrite from_email if the caller didn't set one
                # explicitly (i.e. it's still Django's settings default).
