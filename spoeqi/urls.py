...
urlpatterns = [
    ...
    path('<slug:slug>/workspace/rules/c<int:component>.k4pack',
                                                    views.workspace_packed_component,
                                                    name='workspace_packed_component'),
    path('<slug:slug>/workspace/rules/all64.k4pack',
                                                    views.workspace_packed_all,
                                                    name='workspace_packed_all'),
    path('<slug:slug>/workspace/rules/all64.tar',
                                                    views.workspace_packed_tar,
                                                    name='workspace_packed_tar'),
