...
urlpatterns = [
    ...
    path('<slug:slug>/ca-runner/',            views.ca_runner,                    name='ca_runner'),
    path('<slug:slug>/bindings/',             views.tile_bindings,                name='bindings'),
    path('<slug:slug>/speciate/',             views.tile_speciate,                name='speciate'),
]
