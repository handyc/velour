...
TFT_VARIANTS = {
    '80x160': {
        ...
        # Live-mode sub-CA dims, sized to leave room for BOTH hex-
        # staggers (inner odd-sub-rows shifted +1 px → tile = SUB_W+1
        # wide; outer odd-rows shifted +tile_w/2). With SUB_W=4:
        # tile = 5×4; outer pop = 16×5 + 2 = 82 wide × 16×3 = 48 tall
        # (outer hex y-pack at floor(4*0.866)=3 stride). Centres in
        # the 156×78 effective panel area.
        'sub_w':    4,
        'sub_h':    4,
    },
    '128x128': {
        ...
        # SUB_W=6: tile = 7 wide × 6 tall; outer pop = 16×7 + 3 = 115
        # wide × 16×5 = 80 tall (outer hex y-pack at floor(6*0.866)=5).
        # Fits comfortably in 128×128 with ~13 / ~24 px margin.
        'sub_w':    6,
        'sub_h':    6,
    },
}
