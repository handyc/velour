/* office67.c -- Win95-style suite + local MoE soul. Linux x86_64. No libc.
 *
 *   shell  notepad  sheet  hex  files  calc
 *   ask   soul   garden  hxhnt  rpg  lsys  saver
 *
 * office67 — `soul` app: local mixture-of-experts via officemoe.
 *
