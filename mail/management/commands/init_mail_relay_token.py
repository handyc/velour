...
sysinfo/init_health_token so external apps can POST to /mail/accounts/relay/
...
class Command(BaseCommand):
    help = (
        'Initialize the bearer token for /mail/accounts/relay/. '
    ...
    def handle(self, *args, **opts):
        ...
        self.stdout.write('')
        self.stdout.write('Token (use in Authorization: Bearer header when POSTing to /mail/accounts/relay/):')
        self.stdout.write('')
