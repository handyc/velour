...
TEMPLATES_LIVE = [
    ...
    (1, 3, 'fire rules for [X]',
        '(resolved by concept_cascade handler)',
        0.80, 'fire token-rule cascade for [X]', 'concept_cascade'),
    (3, 2, 'personality state for [X]',
        '(resolved by personality_state handler)',
        0.85, 'compute 4-tuple personality state', 'personality_state'),
    (3, 2, 'state for [X]',
        '(resolved by personality_state handler)',
        0.85, 'shorthand', 'personality_state'),
    (3, 2, 'preset [X]',
        '(resolved by personality_preset handler)',
        0.85, 'look up named personality preset', 'personality_preset'),
