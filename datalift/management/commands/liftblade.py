"""Lift a Blade template tree into Django templates.
...
from datalift.blade_lifter import apply, parse_theme, render_worklist


class Command(BaseCommand):
    help = 'Lift a Laravel Blade template directory into a Django app.'

    def add_arguments(self, parser):
        parser.add_argument('theme', help='Path to the Blade views directory.')
    ...
    def handle(self, *args, **opts):
        ...
        worklist_path = (
            ...
            if opts['worklist']
            else project_root / 'liftblade_worklist.md'
        )
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            f'{skipped} unhandled Blade fragment(s), '
            f'{unhandled} non-Blade PHP file(s) flagged'
