...
# =====================================================================
# Hofstadter models — strange loops, thought experiments, recursive
# self-reference. Absorbed from the standalone hofstadter app.
# =====================================================================
...
class IntrospectiveLayer(models.Model):
    ...
    Where IdentityAssertion organizes self-claims by *how the
    identity is framed* (philosophical / social / mathematical /
    documentary), IntrospectiveLayer organizes them by *what kind
    of thing Velour is claiming to BE at that layer*:
