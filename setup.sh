#!/bin/bash
# setup.sh — unprivileged setup for Velour
#
# Runs as the project user (velour). No sudo, no system changes.
...
#
# On a fresh provisioning, adminsetup.sh invokes this via `sudo -u velour`
